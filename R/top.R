...
#'
#' This function calls the \code{simpleMap()} function to generate a map to plot all locations, passed through by \code{getCoordinates()}. The plot also displays additional information if used by \code{topCompOut()}.
