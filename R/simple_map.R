...
#' @description This function generates a map plotting all locations, filtered by \code{getCoordinates()}.
#' @details
...
#' @param polygon  data frame. Selects toponyms only inside the polygon.
