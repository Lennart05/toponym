...
For the purpose of plotting an edited data frame, we offer the `mapper()`function. This accepts user-defined title, legends, colors, and groups. An example using the previously created data frame is the following, where occurrences of -witz and -itz east of a 10.5 longitudinal line are displayed:
