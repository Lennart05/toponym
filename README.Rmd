...
Since no default path is set upon installation, users need to provide a path. The function `toponymOptions()` allows you to set a persistent path and view it. 
...
The toponym data comes from [GeoNames](https://www.geonames.org/) and will be automatically downloaded when you call any of the core functions.
