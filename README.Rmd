...
This version is discontinued except for bug fixes or issues. For future updates with new functionalities and improvements, please go to the latest version ([v2.0.0](https://github.com/Lennart05/toponym/tree/toponym-CRAN)).

## Installation
In order to install this package, you will need `devtools`. You can download and load `toponym` from [GitHub](https://github.com/Lennart05/toponym) with:
