...
This version is discontinued except for bug fixes or issues. For future updates with new functionalities, head to [this](https://github.com/Lennart05/toponym/tree/toponym-CRAN) GitHub branch and follow the instructions.

## Installation
In order to install this package, you will need `devtools`. You can download and install `toponym` from [GitHub](https://github.com/Lennart05/toponym) with:
